...
public class DestServer {
    ...
    public static void main(String[] args) throws Exception {
        int port = 8800;
        try {
            // Create SSLContext with server certificate and private key
            KeyStore keyStore = KeyStore.getInstance("PKCS12");
            FileInputStream keyStoreFile = new FileInputStream("server-keystore.p12");
            keyStore.load(keyStoreFile, "password".toCharArray()); // Keystore password
            keyStoreFile.close();
            ...
            // Set up SSLContext with the KeyManager
